...
{
    /// <inheritdoc />
    public partial class RefreshAllMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShoes = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemTypeList", x => x.ItemTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagList", x => x.TagId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizeList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SizeList_ItemTypeList_ItemTypeModelId",
                        column: x => x.ItemTypeModelId,
